...
def argparser():
    ...
    parser.add_argument(
        "--prop_algo", type=str, choices=["power", "push", "MC"], default="push"
    )
    ...
    parser.add_argument("--RW", type=int, default=10000, help="random walk times")
    ...
    parser.add_argument(
        "--epochs", type=int, default=100, help="number of optimization steps"
    )
    parser.add_argument(
    ...
    parser.add_argument("--dev", default=1, type=int, help="cuda device, -1 for cpu")
    ...
    # args for attack
    parser.add_argument("--attack_model_id", type=int, default=-1)
    parser.add_argument("--attack_deep",action="store_true",default=False)
    parser.add_argument("--deep_model",action="store_true",default=False)
    parser.add_argument("--attack_model", type=str, default="edge")
    # parser.add_argument("--attack_hidden", type=int, default=128)
    # parser.add_argument("--attack_layer", type=int, default=3)
    # parser.add_argument("--attack_epochs", type=int, default=100)
    # parser.add_argument("--attack_lr", type=float, default=1e-3)
    # parser.add_argument("--attack_wd", type=float, default=5e-4)
    # parser.add_argument("--attack_dropout", type=float, default=0.3)
    # parser.add_argument("--ratio", type=float, default=0.001)
    # parser.add_argument("--attack_train_batch", type=int, default=128)
    # parser.add_argument("--ref_train_batch", type=int, default=1024)
